...
export default {
  ...
  methods: {
      ...
      join() {
          ...
          this.axios.post(
              ...
              qs.stringify({
                  ...
                  price_new: this.$store.state.commodity_data.list.price_new,
                  store_id: this.$store.state.commodity_data.list.store_id,
                  price_new: this.$store.state.commodity_data.list.activity_price,
    ...
    buy() {
      ...
      //   goods_id = this.$route.params.id;
      // }
      else if(this.productData.goods_id) {
