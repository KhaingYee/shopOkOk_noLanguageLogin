<template>
  <div class="box">
      ...
      <ul class="header">
            <li :class="{active:titleIndex == index}" @click="tabList()" v-for="(item,index) in tablist" :key = 'index'><p>{{item}}</p></li>
      </ul>
      <div class="content-box">
        <div class="package-box">
            <div class="content-box-package" v-for="(items,i) in accessories" v-bind:key="items.package_id" v-show="list == 0">
        ...
        <div class="fixedBtm" v-show="list == 0">
...
<script>
    ...
    export default {
        ...
        created(){
            let title = "搭配套餐" + '-' + sessionStorage.getItem('titleKey') + '-' + sessionStorage.getItem('updateDescription');
