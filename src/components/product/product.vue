  ...
  methods: {
          ...
          .then(res => {
              if (res.data.status == 1) {
                  ...
                  for (let i in this.specification.goods) {
                      ...
                      if(this.IId == this.specId[0] && this.tempequal == false) { 
                          ...
                          this.axios({
                              ...
                              this.titleLogo = res.data.data.goods.title;
                              ...
                              let title = this.titleLogo + '-' + sessionStorage.getItem('titleKey') + '-' + sessionStorage.getItem('descriptionpro');
                          ...
                          this.axios.post(this.$httpConfig.goodsComboMatch,qs.stringify({
                              goods_id: this.specific_id,
                              token: sessionStorage.getItem("data_token")
                          })).then((res) => {
    ...
    theSon() {
      ...
      this.axios({
        ...
        method: "get",
        params: {
          id: this.$store.state.commodity_data.goods.id, token: sessionStorage.getItem("data_token")
        }
      })
        .then(res => {
          this.productData = res.data.data.goods;
