	...
	export default {
		data() {
			return {
				...
				Notes: [require("@/assets/images/Notes_off.png"), require("@/assets/images/lc.png")],
				View: [require("@/assets/images/View_off.png"), require("@/assets/images/jd.png")],
				notesImg: require("@/assets/images/lc.png"),
		...
		methods: {
			...
			standAjax() {
				this.axios.post(this.$httpConfig.enterFlow, qs.stringify({
					token: sessionStorage.getItem("data_token")
				}))
					.then((res) => {
			...
			enterAjax() {
				this.axios.post(this.$httpConfig.standardOfInvestment, qs.stringify({
					token: sessionStorage.getItem("data_token")
				}))
					.then((res) => {
			...
			copAjax() {
				this.axios.post(this.$httpConfig.rulesOfCooperation, qs.stringify({
					token: sessionStorage.getItem("data_token")
				}))
					.then((res) => {
