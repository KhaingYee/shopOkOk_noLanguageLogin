	...
	<div class="order-wrap">
		...
		<div class="price-set-wrap">
			<div class="total price clearfix">
				...
				<span class="fr">￥{{(goods_data.price_member * goods_data.goods_num).toFixed(2)}}</span>
			...
			<div class="freight price clearfix">
				...
				<span class="fr" v-if="(goods_data.price_member * goods_data.goods_num) >= expense">-&nbsp;&nbsp;￥{{cut}}</span>
		...
		<div class="footer-wrap">
			...
			<div class="footer clearfix" >
				...
				<div class="fr money">
					实付款&nbsp;:&nbsp; 
					<span class="price">￥
						<span v-if="(money == -1) && ((goods_data.price_member * goods_data.goods_num) >= expense)">{{parseFloat((Number(goods_data.price_member) * Number(goods_data.goods_num) * (Number(cartDis.discount)/100) - Number($store.state.const_coupon_price) - Number(cut)))}}</span>
						<span v-else-if="(money == -1)">{{parseFloat((Number(goods_data.price_member) * Number(goods_data.goods_num) * (Number(cartDis.discount)/100) - Number($store.state.const_coupon_price)))}}</span>
						<span v-else-if="money && ((goods_data.price_member * goods_data.goods_num) >= expense)">{{parseFloat((Number(goods_data.price_member) * Number(goods_data.goods_num) * (Number(cartDis.discount)/100) + Number(money) - Number($store.state.const_coupon_price) - Number(cut)))}}</span>
						<span v-else-if="money">{{parseFloat((Number(goods_data.price_member) * Number(goods_data.goods_num) * (Number(cartDis.discount)/100) + Number(money) - Number($store.state.const_coupon_price)))}}</span>
						<span v-else-if="freight && ((goods_data.price_member * goods_data.goods_num) >= expense)">{{parseFloat((Number(goods_data.price_member) * Number(goods_data.goods_num) * (Number(cartDis.discount)/100) + Number(freight) - Number($store.state.const_coupon_price) - Number(cut)))}}</span>
						<span v-else-if="freight">{{parseFloat((Number(goods_data.price_member) * Number(goods_data.goods_num) * (Number(cartDis.discount)/100) + Number(freight) - Number($store.state.const_coupon_price)))}}</span>
						<span v-else>{{parseFloat((Number(goods_data.price_member) * Number(goods_data.goods_num) * (Number(cartDis.discount)/100) - Number($store.state.const_coupon_price)))|keepTwoNum }}</span>
					</span>
				</div>
