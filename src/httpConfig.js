...
// const request = "http://api.shopsn.cn/wap/admin.php/";
// const request = "http://api.shopsn.net/wap/public/admin.php/"; // thinkphp version 6.0
...
const config = {
    ...
    //登录注册模块
    logOut: request + 'Register/logOut', //退出登录
    ...
    editUserInfo: request + 'User/editUserInfo', //修改个人资料
    uploadPicture: request + 'User/uploadPicture', //上传头像
    resetPassword: request + "User/modifyPassword", //修改密码
    editMobileSendSms: request + 'User/editMobileSendSms', // 修改手机号绑定-发送验证码
    editMobile: request + 'User/editMobile', // 修改手机号绑定

    //个人中心（积分）
    rule: request + 'Integral/rule', // 积分规则
    integralLog: request + 'Integral/integralLog', // 积分明细
    userIntegral: request + 'User/getIntegral', // 我的积分

    //个人中心（用户消息控制器）
    Newslist: request + 'News/lists', // 消息列表
    Newslist1: request + 'StoreHelp/storeHelpList', //优惠券 page
    Newsinfo: request + 'News/info', // 消息详情
    ...
    homeGetClass: request + "Goods/getClass",
    ...
    getDefaultAddress: request + 'UserAddress/getDefaultAddress', // 默认收货地址
    ...
    addressDelete: request + 'UserAddress/addressDelete', // 收货地址删除
    ...
    // 意见
    feedback: request + 'Feedback/feedback', // 意见反馈
    feedbacktype: request + 'FeedBack/feedBackType', // 意见反馈類型
    onlineMessage: request + 'Problem/onlineMessage', // 在线留言

    // 足迹
    deleteFootprint: request + 'Pcenter/deleteFootprint', // 清除我的足迹
    ...
    cancelCollectionGood: request + 'Collection/cancelCollectionGood', //取消收藏
    ...
    balanceRecharge: request + 'Recharge/balanceRecharge', //余额充值
    distill: request + 'MyWallet/distill', //提现
    makeDistill: request + 'MyWallet/makeDistill', // 提现
    ...
    uploadImage: imgRequest + 'UploadImage/uploadImage', //上传图片
    ...
    CompanyStoreAduitProgress: request + 'StoreJoinCompany/getStoreByUser', //企业入驻进度查询
    ...
    openShop: request + '/OpenShopPay/openShop', //开店支付
    PersonStoreAduitProgress: request + 'StorePerson/getStoreByUser', //个人入驻进度查询
    getPayInfo: request + 'StoreInformation/getPayInfo', //审核成功去支付
    ...
    lookGoodsExpress: request + 'LogisticsQuery/lookGoodsExpress', //订单物流
    deleteOrder: request + 'Order/deleteOrder', //删除订单
    getCommentImageConfig:  imgRequest + 'FileUpload/getCommentImageConfig', //获取上传图片接口配置
    uploadImageByImageComment: imgRequest + 'FileUpload/uploadImageByImageComment', //上传评论图片
    ...
    // report: request + 'GoodsReport/report',
    // reportTopic: request + 'GoodsReport/reportTopic',
    // commitReport: request + 'GoodsReport/commitReport',
